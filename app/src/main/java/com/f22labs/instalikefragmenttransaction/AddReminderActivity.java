...
import com.f22labs.instalikefragmenttransaction.reminder.AlarmScheduler;
...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.d("dryrun","Entered");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_reminder);
        Log.d("dryrun","LAYOUT SET");
        Intent intent = getIntent();
        mCurrentReminderUri = intent.getData();
        Log.d("dryrun","intent le liya");
        ...
        mTime = mHour + ":" + mMinute;
        Log.d("dryrun","initialize ho gya");
        ...
        Log.d("dryrun","textwatcher ho gya");
        ...
        Log.d("dryrun","set bhi kr liya");
        // To save state on device rotation
        if (savedInstanceState != null) {
            Log.d("dryrun","null ni h");
            ...
            Log.d("dryrun","bahut sare lines baad");
            mActive = savedInstanceState.getString(KEY_ACTIVE);
        }
        Log.d("dryrun","null thi lagta h "+mActive);
