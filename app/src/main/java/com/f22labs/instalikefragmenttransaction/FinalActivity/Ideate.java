...
public class Ideate extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Bitmap bitmap1 = BitmapFactory.decodeResource(rootView.getResources(),R.drawable.ideate);
        ...
        download.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {new functions().retrieve("Ideate",view.getContext());
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                LayoutInflater factory = LayoutInflater.from(Ideate.this.getContext());
...
//text_entry is an Layout XML file containing two text field to display in alert dialog
                ...
                final AlertDialog.Builder alert = new AlertDialog.Builder(Ideate.this.getContext());
...
//                                        captain_name = input2.getText().toString();
                                        if(team_name.equals(""))
                                        {
                                            Toast.makeText(Ideate.this.getContext(),"Enter the Value in Team Name",Toast.LENGTH_SHORT).show();
                                        }
                                        else{
                                            new functions().feed("Ideate",team_name);
                                            Toast.makeText(Ideate.this.getContext(),"Registered for the event",Toast.LENGTH_SHORT).show();
