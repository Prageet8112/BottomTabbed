...
public class CodeWars3 extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Bitmap bitmap1 = BitmapFactory.decodeResource(rootView.getResources(),R.drawable.codewar);
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new functions().retrieve("CodeWars3",view.getContext());
        ...
        register.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new functions().feed("CodeWars3","Single");
