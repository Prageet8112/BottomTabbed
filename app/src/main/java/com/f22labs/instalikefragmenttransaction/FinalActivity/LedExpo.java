...
public class LedExpo extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_led_expo, container, false);

        ButterKnife.bind(this, rootView);

        ImageView img1 = (ImageView) rootView.findViewById(R.id.subactimage1);

        Bitmap bitmap1 = BitmapFactory.decodeResource(rootView.getResources(),R.drawable.ledexpo);
        ...
        download.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {new functions().retrieve("LedExpo",view.getContext());
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                LayoutInflater factory = LayoutInflater.from(LedExpo.this.getContext());
...
//text_entry is an Layout XML file containing two text field to display in alert dialog
                ...
                final AlertDialog.Builder alert = new AlertDialog.Builder(LedExpo.this.getContext());
...
//                                        captain_name = input2.getText().toString();
                                        if(team_name.equals(""))
                                        {
                                            Toast.makeText(LedExpo.this.getContext(),"Enter the Value in Team Name",Toast.LENGTH_SHORT).show();
                                        }
                                        else{
                                            new functions().feed("LedExpo",team_name);
                                            Toast.makeText(LedExpo.this.getContext(),"Registered for the event",Toast.LENGTH_SHORT).show();
    ...
    public static LedExpo newInstance(int instance) {
        Bundle args = new Bundle();
        args.putInt(ARGS_INSTANCE, instance);
        LedExpo fragment = new LedExpo();
