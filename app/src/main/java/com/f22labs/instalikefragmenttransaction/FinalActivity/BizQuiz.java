...
public class BizQuiz extends BaseFragment {

    @BindView(R.id.download)
    Button download;
    @BindView(R.id.register)
    Button register;
    String team_name,captain_name;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_biz_quiz, container, false);

        ButterKnife.bind(this, rootView);

        ImageView img1 = (ImageView) rootView.findViewById(R.id.subactimage1);

        Bitmap bitmap1 = BitmapFactory.decodeResource(rootView.getResources(),R.drawable.bizquiz);
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new functions().retrieve("BizQuiz",view.getContext());
        ...
        register.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LayoutInflater factory = LayoutInflater.from(BizQuiz.this.getContext());
...
//text_entry is an Layout XML file containing two text field to display in alert dialog
             ...
             //   input2.setText("", TextView.BufferType.EDITABLE);
                final AlertDialog.Builder alert = new AlertDialog.Builder(BizQuiz.this.getContext());
...
//                                        captain_name = input2.getText().toString();
                                        if(team_name.equals(""))
                                        {
                                            Toast.makeText(BizQuiz.this.getContext(),"Enter the Value in Team Name",Toast.LENGTH_SHORT).show();
                                        }
                                        else{
                                            new functions().feed("BizQuiz",team_name);
                                            Toast.makeText(BizQuiz.this.getContext(),"Registered for the event",Toast.LENGTH_SHORT).show();
    ...
    public static BizQuiz newInstance(int instance) {
        Bundle args = new Bundle();
        args.putInt(ARGS_INSTANCE, instance);
        BizQuiz fragment = new BizQuiz();
